...
\subsection{Obliczanie odległości pomiędzy dwoma punktami geograficznymi}
...
\captionof{table}{Tabela przedstawiająca współrzędne nieporuszającego się odbiornika.}\label{table:punktygps}
\begin{tabular}{|c|c|c|}
\hline
